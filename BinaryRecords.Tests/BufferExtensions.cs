...
namespace BinaryRecords.Tests
{
    ...
    {
        public static void WriteVarInt(this ref SpanBufferWriter buffer, int value)
        ...
        public static void WriteVarLong(this ref SpanBufferWriter buffer, long value)
        ...
        public static void WriteVarULong(this ref SpanBufferWriter buffer, ulong value)
        {
            do
            {
        ...
        public static void WriteVarBytes(this ref SpanBufferWriter buffer, ReadOnlySpan<byte> bytes)
        {
        ...
        public static void WriteString(this ref SpanBufferWriter buffer, string value)
        {
        ...
        public static void WriteIPEndPoint(this ref SpanBufferWriter buffer, IPEndPoint ipEndPoint)
        {
